 ...
 */
#if !defined(QM3X_BYPASS_TRC_H) || defined(TRACE_HEADER_MULTI_READ)
#define QM3X_BYPASS_TRC_H
...
/* clang-format on */
TRACE_DEFINE_ENUM(QM3X_BYPASS_IRQ);
TRACE_DEFINE_ENUM(QM3X_BYPASS_NOTIFICATION);
TRACE_DEFINE_ENUM(QM3X_BYPASS_RESPONSE);
...
/* clang-format on */
TRACE_DEFINE_ENUM(QM3X_BYPASS_ACTION_RESET);
TRACE_DEFINE_ENUM(QM3X_BYPASS_ACTION_FWUPD);
TRACE_DEFINE_ENUM(QM3X_BYPASS_ACTION_POWER);
TRACE_DEFINE_ENUM(QM3X_BYPASS_ACTION_MSG_TYPE);
#define BYPASS_ACTION_PR_ARG \
	__print_symbolic(__entry->action, BYPASS_ACTION_SYMBOLS)

#endif /* !QM3X_BYPASS_TRC_H || TRACE_HEADER_MULTI_READ */
