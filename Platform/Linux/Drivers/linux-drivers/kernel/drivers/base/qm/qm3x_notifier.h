 ...
 */
#ifndef __QM3X_NOTIFIER_H
#define __QM3X_NOTIFIER_H
...
/**
 * enum qm3x_notifier_events - The qm35 events that can be notified.
 * @QM3X_NOTIFIER_EVENT_NEW: A new qm35 device has been created.
 * @QM3X_NOTIFIER_EVENT_DELETE: An old qm35 device will be deleted.
 * @QM3X_NOTIFIER_EVENT_ONLINE: A qm35 device is online.
 * @QM3X_NOTIFIER_EVENT_MAX: Number of different events defined.
 *
 * Notes:
 * A notified block may only return NOTIFY_DONE from
 * QM3X_NOTIFIER_EVENT_NEW & QM3X_NOTIFIER_EVENT_ONLINE events.
 *
 * A notified block may return NOTIFY_DONE or NOTIFY_STOP from
 * a QM3X_NOTIFIER_EVENT_DELETE event.  In the later case, the previously
 * notified blocks in the chain will be rolled back by being sent a new
 * QM3X_NOTIFIER_EVENT_NEW event.  The device will be deleted only
 * if no notified block returns NOTIFY_STOP.
 */
enum qm3x_notifier_events {
	QM3X_NOTIFIER_EVENT_NEW,
	QM3X_NOTIFIER_EVENT_DELETE,
	QM3X_NOTIFIER_EVENT_ONLINE,
	QM3X_NOTIFIER_EVENT_MAX,
...
#ifdef QM3X_NOTIFIER_TESTS

#include "qm3x_ids.h"

int ku_qm3x_foreach_id(qm3x_ids_cb process, void *argument);
int ku_blocking_notifier_chain_register(struct blocking_notifier_head *nh,
					struct notifier_block *n);

#define qm3x_foreach_id(p, a) ku_qm3x_foreach_id(p, a)
...
#endif /* QM3X_NOTIFIER_TESTS */

#endif /* __QM3X_NOTIFIER_H */
