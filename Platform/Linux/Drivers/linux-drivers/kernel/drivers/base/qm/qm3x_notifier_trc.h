 ...
 */
#if !defined(__QM3X_NOTIFIER_TRC_H) || defined(TRACE_HEADER_MULTI_READ)
#define __QM3X_NOTIFIER_TRC_H
...
#define notifier_event_name(name)                 \
	{                                         \
		QM3X_NOTIFIER_EVENT_##name, #name \
	}
/* clang-format off */
...
/* clang-format on */
TRACE_DEFINE_ENUM(QM3X_NOTIFIER_EVENT_NEW);
TRACE_DEFINE_ENUM(QM3X_NOTIFIER_EVENT_DELETE);
TRACE_DEFINE_ENUM(QM3X_NOTIFIER_EVENT_ONLINE);
#define NOTIFIER_EVENT_PR_ARG \
	__print_symbolic(__entry->event, NOTIFIER_EVENT_SYMBOLS)

#endif /* !__QM3X_NOTIFIER_TRC_H */
