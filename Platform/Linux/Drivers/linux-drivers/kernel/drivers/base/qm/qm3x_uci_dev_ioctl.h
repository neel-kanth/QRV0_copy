 ...
 */
#ifndef __QM3X_UCI_DEV_IOCTL_H
#define __QM3X_UCI_DEV_IOCTL_H

#define QM3X_UCI_DEV_IOC_TYPE 'U'
 ...
 *   Setting the parameter to 0 or 1 will disable or enable IRQ.
...
/**
 * enum qm3x_uci_dev_states - States of the UCI char device.
 * @QM3X_UCI_DEV_CTRL_STATE_UNKNOWN: Unknown state.
 * @QM3X_UCI_DEV_CTRL_STATE_OFF: Power off state.
 * @QM3X_UCI_DEV_CTRL_STATE_RESET: Reset state.
 * @QM3X_UCI_DEV_CTRL_STATE_COREDUMP: Core dump state.
 * @QM3X_UCI_DEV_CTRL_STATE_READY: Ready state.
 * @QM3X_UCI_DEV_CTRL_STATE_FW_DOWNLOADING: Firmware downloading state.
 * @QM3X_UCI_DEV_CTRL_STATE_UCI_APP: UCI application state.
 */
enum qm3x_uci_dev_states {
	QM3X_UCI_DEV_CTRL_STATE_UNKNOWN = 0x0000,
	QM3X_UCI_DEV_CTRL_STATE_OFF = 0x0001,
	QM3X_UCI_DEV_CTRL_STATE_RESET = 0x0002,
	QM3X_UCI_DEV_CTRL_STATE_COREDUMP = 0x0004,
	QM3X_UCI_DEV_CTRL_STATE_READY = 0x0008,
	QM3X_UCI_DEV_CTRL_STATE_FW_DOWNLOADING = 0x0010,
	QM3X_UCI_DEV_CTRL_STATE_UCI_APP = 0x0020,
};
...
#define QM35_CTRL_RESET _IOR(QM3X_UCI_DEV_IOC_TYPE, 1, unsigned int)
#define QM35_CTRL_RESET_EXT _IOW(QM3X_UCI_DEV_IOC_TYPE, 1, unsigned int)
#define QM35_CTRL_GET_STATE _IOR(QM3X_UCI_DEV_IOC_TYPE, 2, unsigned int)
#define QM35_CTRL_FW_UPLOAD _IOR(QM3X_UCI_DEV_IOC_TYPE, 3, unsigned int)
#define QM35_CTRL_FW_UPLOAD_EXT \
	_IOW(QM3X_UCI_DEV_IOC_TYPE, 3, struct qm35_fwupload_params)
#define QM35_CTRL_POWER _IOW(QM3X_UCI_DEV_IOC_TYPE, 4, unsigned int)
#define QM35_CTRL_SET_STATE _IOW(QM3X_UCI_DEV_IOC_TYPE, 5, unsigned int)
#define QM35_CTRL_GET_TYPE _IOR(QM3X_UCI_DEV_IOC_TYPE, 6, unsigned int)
#define QM35_CTRL_SET_TYPE _IOW(QM3X_UCI_DEV_IOC_TYPE, 7, unsigned int)
#define QM35_CTRL_WAIT_EVENT _IOR(QM3X_UCI_DEV_IOC_TYPE, 8, unsigned int)
#define QM35_CTRL_IRQ _IOW(QM3X_UCI_DEV_IOC_TYPE, 9, unsigned int)
#define QM35_CTRL_WAIT_IRQ _IOW(QM3X_UCI_DEV_IOC_TYPE, 10, unsigned int)
#define QM35_CTRL_SPI_TRANSFER \
	_IOW(QM3X_UCI_DEV_IOC_TYPE, 11, struct qm35_spi_transfer_params)

#endif /* __QM3X_UCI_DEV_IOCTL_H */
