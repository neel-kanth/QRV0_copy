 ...
 * @QMSPI_RESERVED: Reserved for future use.
 ...
 * @awake_count: Indicate number of received awake packet from FW.
 ...
 * @irq_count: IRQ counter to detect QM chip wakeup.
 * @prd_length: Integer to store the length of the pre read.
 * @info_bin_attr: Info file attributes.
 * @info_mutex: Mutex for accessing info.
 * @info_length: Length in info_buf.
 * @info_buf: Info file.
 */
...
static inline struct qm35_spi *qm35_to_qm35_spi(const struct qm3x *qm35)
{
