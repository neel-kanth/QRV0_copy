...
extern const struct qm3x_transport qm35_spi_transport;
...
static int ku_qm35_fw_get_vendor_version(struct qm35_spi *qmspi,
					 struct qm3x_fw_version *version);
...
static void ku_qm3x_state_set(struct qm3x *qm35, enum qm3x_state device_state);
static int ku_qm3x_state_wait(struct qm3x *qm35, enum qm3x_state device_state);
#define qm3x_state_set ku_qm3x_state_set
#define qm3x_state_wait ku_qm3x_state_wait
...
static int ku_gpiod_get_value(const struct gpio_desc *desc);
