...
static const uint8_t util_calib_qm357_sip_ant_pair_0_ant_path[] = { 0x03,
								    0x01 };
static const uint8_t util_calib_qm357_sip_ant_pair_1_ant_path[] = { 0x02,
								    0x01 };
static const uint8_t util_calib_qm357_sip_ant_set0_tx_ant_paths[] = { 0x00,
								      0xFF };
static const uint8_t util_calib_qm357_sip_ant_set3_tx_ant_paths[] = { 0x00,
								      0xFF };
static const uint8_t util_calib_qm357_sip_ant_set0_rx_ants[] = { 0x00, 0x01,
								 0x00 };
static const uint8_t util_calib_qm357_sip_ant_set3_rx_ants[] = { 0x02, 0xFF,
								 0xFF };

static const uint16_t util_calib_qm357_sip_pdoa_lut0_ch5[][2] = {
...
static const uint16_t util_calib_qm357_sip_pdoa_lut1_ch9[][2] = {
...
static const uint16_t util_calib_qm357_sip_pdoa_lut2_ch5[][2] = {
...
static const uint16_t util_calib_qm357_sip_pdoa_lut3_ch9[][2] = {
...
static const struct cherry_calib_key util_partial_calib_qm357_sip_keys[] = {
	/* PDOA LUT Configuration. */
	CHERRY_CALIB_NUMBER_ARRAY_2D("pdoa_lut0.data",
				     util_calib_qm357_sip_pdoa_lut0_ch5),
	CHERRY_CALIB_NUMBER_ARRAY_2D("pdoa_lut1.data",
				     util_calib_qm357_sip_pdoa_lut1_ch9),
	CHERRY_CALIB_NUMBER_ARRAY_2D("pdoa_lut2.data",
				     util_calib_qm357_sip_pdoa_lut2_ch5),
	CHERRY_CALIB_NUMBER_ARRAY_2D("pdoa_lut3.data",
				     util_calib_qm357_sip_pdoa_lut3_ch9),
...
static const struct cherry_calib_key util_calib_qm357_sip_keys[] = {
	/* Global Calibration. */
	...
	CHERRY_CALIB_UINT8("ant1.port", 2), CHERRY_CALIB_UINT8("ant1.lna", 1),
	...
	CHERRY_CALIB_UINT8("ant2.port", 3), CHERRY_CALIB_UINT8("ant2.lna", 1),
	...
	CHERRY_CALIB_UINT8("ant3.port", 4), CHERRY_CALIB_UINT8("ant3.lna", 1),
	...
	CHERRY_CALIB_NUMBER_ARRAY_1D("ant_pair0.ant_paths",
				     util_calib_qm357_sip_ant_pair_0_ant_path),
	...
	CHERRY_CALIB_NUMBER_ARRAY_1D("ant_pair1.ant_paths",
				     util_calib_qm357_sip_ant_pair_1_ant_path),
	...
	CHERRY_CALIB_NUMBER_ARRAY_1D("ant_set0.tx_ant_paths",
				     util_calib_qm357_sip_ant_set0_tx_ant_paths),
	...
	CHERRY_CALIB_NUMBER_ARRAY_1D("ant_set0.rx_ants",
				     util_calib_qm357_sip_ant_set0_rx_ants),
	CHERRY_CALIB_UINT8("ant_set0.tx_power_control", 1),

	/* Ant Set3 : for radar. */
	CHERRY_CALIB_NUMBER_ARRAY_1D("ant_set3.tx_ant_paths",
				     util_calib_qm357_sip_ant_set3_tx_ant_paths),
	...
	CHERRY_CALIB_NUMBER_ARRAY_1D("ant_set3.rx_ants",
				     util_calib_qm357_sip_ant_set3_rx_ants),
	CHERRY_CALIB_UINT8(
		"ant_set3.tx_power_control",
		0x80), /* This key needs be set to 0x80 to work on cyan fw */
};

static const struct cherry_calib util_calib_qm357_sip = {
	.n_keys = sizeof(util_calib_qm357_sip_keys) /
		  sizeof(util_calib_qm357_sip_keys[0]),
	.keys = util_calib_qm357_sip_keys,
};

static const struct cherry_calib util_partial_calib_qm357_sip = {
	.n_keys = sizeof(util_partial_calib_qm357_sip_keys) /
		  sizeof(util_partial_calib_qm357_sip_keys[0]),
	.keys = util_partial_calib_qm357_sip_keys,
};
