...
import os
from .fira import *  # noqa: F403
from .qorvo import *  # noqa: F403
...
excluded_addins = os.getenv("UQT_EXCLUDED_ADDINS")
if excluded_addins:
    excluded_addins = excluded_addins.split(":")
    for addin in excluded_addins:
        if addin in addins_to_load:
            addins_to_load.remove(addin)
