...
import logging
from . import core
from .utils import ExtendableClass, UciComError, UciComStatus, FP, Buffer

from .fira_app import TestParam
from .fira_conf import config_params, Config
...
class Client_extension:
    ...
    def test_sr_rx(self, payload):
        payload = self.command(Gid.Test, OidTest.SrRx, b"")
