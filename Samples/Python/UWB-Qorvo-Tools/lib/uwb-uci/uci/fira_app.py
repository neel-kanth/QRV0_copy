...
class App(DynIntEnum):
    ...
    SecureRangingNefaLevel = (0x4A,)
    SecureRangingCswLength = (0x4B,)
    OwrAoaMeasurementNtfPeriod = 0x4D
    HopModeKey = 0xA0
    CccUwbTime0 = 0xA1
    CccResponderSlotIndex = 0xA2
    SelectedProtVer = 0xA3
    SelectedUwbConfigId = 0xA4
    SelectedShapeCombo = 0xA5
    URSK_TTL = 0xA6
    CccResponderParticipationConfig = 0xA7
    CccStsIndex = 0xA8
    DlTdoaRangingMethod = 0x3D
    Mac_mode = 0xA9
    Ursk = 0xAA
    DlTdoaAnchorLocationV2 = 0x4E
    DlTdoaMeasurementNtfV2 = 0x4F
...
App.defs = [
    ...
    (App.DeviceMacAddress, 1),  # given as a list of bytes
    (App.DstMacAddress, 2),  # or 8?
    (App.SlotDuration, 2),
    (App.RangingDuration, 4),
    (App.StsIndex, 4),
    (App.MacFcsType, 1),
    ...
    (App.VendorId, 1),  # given as a list of bytes
    (App.StaticStsIv, 1),  # given as a list of bytes
    ...
    (App.SessionTimeBase, [9, [1, 4, 4]]),
    (App.HopModeKey, [4, 16]),
    (App.CccUwbTime0, 8),
    (App.CccResponderSlotIndex, 1),
    (App.SelectedProtVer, 2),
    (App.SelectedShapeCombo, 1),
    (App.URSK_TTL, 2),
    (App.CccResponderParticipationConfig, 1),
    ...
    (App.SecureRangingNefaLevel, 1),
    (App.SecureRangingCswLength, 1),
    (App.OwrAoaMeasurementNtfPeriod, 1),
    (App.Mac_mode, 1),
    (App.Ursk, 32),
    (App.DlTdoaAnchorLocationV2, 1),  # could also be 17 or 19
    (App.DlTdoaMeasurementNtfV2, 1),
]
