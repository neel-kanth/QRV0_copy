...
class DeviceType:
    def __init__(self, value):
        ...
        self.ccc_controller_supported = bool(_capability_flags & 0x04)
        self.ccc_controlee_supported = bool(_capability_flags & 0x08)
    ...
    def __str__(self):
        return (
            ...
            f"    CCC Controller: {'Supported' if self.ccc_controller_supported else 'Not supported'}\n"
            f"    CCC Controlee: {'Supported' if self.ccc_controlee_supported else 'Not supported'}\n"
        )
...
class RangingMethod:
    def __init__(self, value):
        ...
        self.data_transfer_mode_supported = bool(_capability_flags & 0x200)
    ...
    def __str__(self):
        return (
            ...
            f"    Data Transfer Mode: {'Supported' if self.data_transfer_mode_supported else 'Not supported'}\n"
        )
