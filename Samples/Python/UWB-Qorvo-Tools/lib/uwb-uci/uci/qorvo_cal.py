...
class CalibrationParams(DynIntEnum):
    ...
    WifiCoexMaxGrantDuration = 0x43
    TrxAutoSelectAccumPeriod = 0x44
    TrxAutoSelectRssiDiffRes = 0x45
    TrxAutoSelectErrorRateThres = 0x46
    WifiCoexMinInactiveDuration = 0x47
    RssiOffSetQ3 = 0x4F
    WifiSwCfg = 0x50
    DebugPllBiasTrim = 0x51
    ByPassDelayOffset = 0x52
    Ch9WifiCoexTimeGap = 0x53
    Ch9WifiCoexMaxGrantDuration = 0x54
    Ch9WifiCoexMinInactiveDuration = 0x55
...
CalibrationParams.defs = [
    ...
    (CalibrationParams.TxAntPath, 2, r"ant_set\d+\.tx_ant_paths$"),
    ...
    (CalibrationParams.WifiCoexMaxGrantDuration, 1, r"wifi_coex_max_grant_duration$"),
    (
        CalibrationParams.WifiCoexMinInactiveDuration,
        1,
        r"wifi_coex_min_inactive_duration$",
    ),
    (CalibrationParams.Ch9WifiCoexTimeGap, 1, r"ch9.wifi_coex_time_gap$"),
    (
        CalibrationParams.Ch9WifiCoexMaxGrantDuration,
        1,
        r"ch9.wifi_coex_max_grant_duration$",
    ),
    (
        CalibrationParams.Ch9WifiCoexMinInactiveDuration,
        1,
        r"ch9.wifi_coex_min_inactive_duration$",
    ),
    ...
    (
        CalibrationParams.TrxAutoSelectErrorRateThres,
        1,
        r"trx_auto_select\.error_rate_thres$",
    ),
    (
        CalibrationParams.TrxAutoSelectRssiDiffRes,
        1,
        r"trx_auto_select\.rssi_diff_thres$",
    ),
    (CalibrationParams.TrxAutoSelectAccumPeriod, 1, r"trx_auto_select\.accum_period$"),
...
cal_params_in = (
    ...
    (dot("ant_set", set_id, ".tx_ant_paths"), Uint16),
    ...
    (["ch9.wifi_coex_time_gap"], Uint8),
    (
        ["ch9.wifi_coex_max_grant_duration", "ch9.wifi_coex_min_inactive_duration"],
        Uint8,
    ),
    ...
    (
        [
            "trx_auto_select.accum_period",
            "trx_auto_select.rssi_diff_thres",
            "trx_auto_select.error_rate_thres",
        ],
        Uint8,
    ),
    ...
    (dot("ant", ant_id, ".ch", [5, 9], ".pg_count"), Uint8),
    (dot("ant", ant_id, ".ch", [5, 9], ".pg_delay"), Uint8),
