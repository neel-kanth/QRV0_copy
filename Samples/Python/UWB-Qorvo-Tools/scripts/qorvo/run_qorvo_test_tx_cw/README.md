...
Script **run_qorvo_test_tx_cw** is provided to demonstrate Qorvo Continuous Wave TX Test. This test configures the device to transmit a Continuous Wave (CW) at a specified channel QM35 UWB radio to transmit a Continuous Wave (CW) at a specified channel frequency. This may be of use as part of crystal trimming procedure.
...
The Qorvo Continuous Wave TX Test shall be triggered by using TEST_TX_CW_CMD command and UWBS SHALL respond by TEST_TX_CW_CMD when command is accepted successfully.
